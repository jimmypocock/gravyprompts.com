...
describe('List Prompts Lambda', () => {
  ...
  describe('Successful listing', () => {
    ...
    it('should return nextKey when more results exist', async () => {
      ...
      expect(response.statusCode).toBe(200);
      expect(parsedResponse.lastKey).toBe(encodeURIComponent(JSON.stringify(lastEvaluatedKey)));
    });
  });
  ...
  describe('Error handling', () => {
    ...
    it('should handle invalid lastKey parameter', async () => {
      ...
      expect(response.statusCode).toBe(200);
      expect(consoleWarnSpy).toHaveBeenCalledWith('Invalid lastKey parameter:', expect.any(String));
  ...
  describe('Logging', () => {
    ...
    it('should log errors', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Error listing prompts:', error);
