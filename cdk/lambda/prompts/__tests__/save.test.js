...
The Team`;
    ...
    it('should handle special characters in content', async () => {
      ...
      expect(response.statusCode).toBe(201);
      expect(parsedResponse.content).toBe('Price: $99.99 (10% off!) & "free" shipping');
    });
  });
  ...
  describe('Validation', () => {
    it('should require templateTitle', async () => {
      ...
      expect(parsedResponse.error).toBe('Missing required fields: templateTitle and content');
    });
  ...
  describe('Logging', () => {
    ...
    it('should log errors', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('Error saving prompt:', error);
