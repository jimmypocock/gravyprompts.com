...
describe('Auth Module', () => {
  ...
  describe('decodeJwtPayload', () => {
    ...
    it('should decode a valid JWT token', () => {
      ...
      const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20ifQ.dFlhwTr7SB0POzF5MZKxg7d0XjkQW0IjUb-cO_3sUOs';
    ...
    it('should return null when not in SAM Local environment', () => {
      delete process.env.AWS_SAM_LOCAL;
      const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMifQ.hmRXfJhjaXLKAtKjcZwXpcJDVALKUF9Z4L8NDQRJ8gE';
  ...
  describe('getUserFromEvent', () => {
    ...
    it('should decode JWT from Authorization header when no authorizer', async () => {
      ...
      const event = {
        headers: {
          Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMiLCJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJuYW1lIjoiVGVzdCBVc2VyIiwiZW1haWxfdmVyaWZpZWQiOnRydWUsImNvZ25pdG86dXNlcm5hbWUiOiJ0ZXN0dXNlciJ9.YH3g9kYPbzm_fBCNM5JAkKj7TKJ76qwqPbmVPrJNiHg'
        }
      };
