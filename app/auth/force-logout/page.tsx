      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-lg text-center">
        {status === 'loading' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-900">Clearing session...</h2>
            <p className="text-gray-600">Please wait while we sign you out completely.</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-900">Successfully signed out</h2>
        ...
        {status === 'error' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-900">Error signing out</h2>
