        ...
        <div className="glass-card p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-xl text-gray-600 mb-8">
              These Terms of Service govern your use of our application and
            ...
            <p className="text-gray-600 mb-6">
              Permission is granted to temporarily access our application for
            ...
            <p className="text-gray-600 mb-6">
              ...
              or inability to use the materials in this application, even if we
            ...
            <p className="text-gray-600 mb-6">
              ...
              current. We may make changes to the materials contained in this
            ...
            <p className="text-gray-600 mb-6">
              ...
              and are not responsible for the contents of any such linked site.
            ...
            <p className="text-gray-600 mb-6">
              We may revise these terms of service for its application at any
