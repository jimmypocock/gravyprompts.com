...
describe("ApprovalHistory", () => {
  ...
  describe("data loading", () => {
    ...
    it("should handle API errors gracefully", async () => {
      (getApprovalHistory as jest.Mock).mockRejectedValue(
        new Error("API Error"),
      );
  ...
  describe("data display", () => {
    ...
    it("should display action status with icons", async () => {
      ...
      await waitFor(() => {
        ...
        const approvedStatusElements = document.querySelectorAll(
          "span.text-green-600",
        );
        ...
        const rejectedStatusElement =
          document.querySelector("span.text-red-600");
    ...
    it("should display reason and notes when available", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText("Reason: Inappropriate content"),
        ).toBeInTheDocument();
  ...
  describe("edge cases", () => {
    ...
    it("should handle empty filter results", async () => {
      const onlyApprovedHistory = mockHistoryData.filter(
